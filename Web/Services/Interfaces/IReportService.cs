...
namespace StudyShare.Services.Interfaces
{
    public interface IReportService
    {
        ...
        Task<bool> CreateReportAsync(string reporterId, string targetUserId, string reason, int? questionId = null, int? answerId = null, string? targetContentSnapshot = null);
        Task<int> CreateAutoReportAsync(string targetUserId, string reason, string actionTaken, int? docId = null, int? qid = null, string? targetContentSnapshot = null);
    }
}
